...
export default {
  ...
  data() {
    return {
      ocrType: [
        ...
        {provider: 'paddle', name: 'PaddleOCR（离线识别）'}
      ],
  ...
  methods: {
     ...
     */
    apiAvailable() {
      const providerName = {baidu: '百度', tencent: '腾讯', xunfei: '讯飞', youdao: '有道', ali: '阿里', tesseract: 'Tesseract', tesseractSystem: 'TesseractOCR', paddle: 'PaddleOCR'};
      let status = true;
      // 获取 OCR 提供商
